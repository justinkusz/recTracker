  ...
  describe("# Recommendations", () => {
      ...
      it("should add and return a new recommendation", done => {
        ...
        request(app)
          ...
          .end((err, res) => {
            ...
            Recommendation.find({ _owner: users[0]._id })
              .then(recs => {
      ...
      it("should return a 401 if user is not authenticated", done => {
        ...
        request(app)
          ...
          .end((err, res) => {
            ...
            Recommendation.find({ _owner: users[1]._id })
              .then(recs => {
    ...
    describe("GET /recs/by/:recommender", () => {
      it("should return a 404 if recommender is not found", done => {
        request(app)
          .get("/recs/by/somebogusrecommender")
          .set("x-auth", users[0].tokens[0].token)
          .expect(404)
          .end(done);
      });
      ...
      it("should return recs by recommender", done => {
        request(app)
          .get(`/recs/by/${recs[0].recommender}`)
          .set("x-auth", users[0].tokens[0].token)
          .expect(200)
          .expect(res => {
      ...
      it("should return a specific rec if user is owner", done => {
        request(app)
          ...
          .end((err, res) => {
            ...
            Recommendation.findById(recs[0]._id)
              .then(rec => {
      ...
      it("should return a 401 if not authenticated", done => {
        ...
        request(app)
          ...
          .end((err, res) => {
            ...
            Recommendation.findById(rec._id)
              .then(rec => {
      ...
      it("should return a 404 if user is not owner", done => {
        request(app)
          ...
          .end((err, res) => {
            ...
            Recommendation.findById(recs[1]._id)
              .then(rec => {
                expect(rec).toBeTruthy();
                done();
              })
